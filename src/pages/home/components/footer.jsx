...
function Footer() {
  return (
    <div className=" max-w-[100vw] lg:max-w-[1440px] flex flex-col items-center py-[5vh] space-y-[6vh] px-[5vw] bg-[#110b20] relative z-[-99]">
            ...
            <img src={star4} className="absolute top-[9vh] left-[68%]" />
            <img src={star5} className="absolute top-[10vh] left-[2%]" />
      ...
      <div className="flex lg:flex-row flex-col items-start justify-evenly w-[100%]">
        <div className="lg:w-[50%] w-[100%]">
          ...
          <div className="text-[1.5vh] mb-12">
            Getlinked Tech Hackathon is a technology innovation program <br className="hidden lg:block"/>
            established by a group of organizations with the aim of showcasing{" "}
            <br className="hidden lg:block"/>
            young and talented individuals in the field of technology
          </div>
          <div className="text-[1.5vh] mb-12 lg:mb-0">Terms of Use <span className="text-[#d434fe]">|</span> Privacy Policy</div>
        </div>
        ...
        <div className="text-[1.5vh] space-y-[1vh] lg:w-[25%] mt-12 lg:mt-0">
          ...
          <div className="flex flex-row space-x-3 items-center"><img src={call} className="h-[1vh]"/><div>+234 6707653444</div></div>
          <div className="flex flex-row space-x-3">
            <img src={locate} className="h-[1vh]"/><div>27,Alara Street
            <br/>
            Yaba 100012
            <br/>
            Lagos State</div>
