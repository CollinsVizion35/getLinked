      ...
      <div>
        <div className='flex flex-row text-center items-center space-x-6'>
          <div className=' flex flex-row items-baseline'>
            <div className=' md:text-[2em] text-[2em]'>
              {timeRemaining.hours}
            </div>
            <div className=' text-[0.6em] '>H</div>
          </div>
          <div className=' flex flex-row items-baseline'>
            <div className=' md:text-[2em] text-[2em]'>
            ...
            <div className=' text-[0.6em] '>M</div>
          </div>
          <div className=' flex flex-row items-baseline'>
            <div className=' md:text-[2em] text-[2em]'>
            ...
            <div className=' text-[0.6em] '>S</div>
          </div>
        </div>
      </div>
      {/* )} */}
...
function Deadline() {
  const { deadlineTime } = DeadlinePass()
