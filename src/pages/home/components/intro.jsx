    ...
    return (
        <div className='lg:min-h-[50vh] min-h-[100vh]  max-w-[100vw] lg:max-w-[1440px] flex lg:flex-row flex-col items-center px-[5%] relative border-b border-[#2c233e]'>
            ...
            <div className='lg:w-[50%] w-[100%] py-[5vh]'>
                <JackInTheBox duration={5000}><img src={bigIdea} alt='the big idea' className='lg:h-[50vh] h-[40vh] lg:ml-[10%] mx-auto'/></JackInTheBox></div>
            <div className='flex  flex-col py-[5vh] '>
                <Slide duration={5000} direction='right'><div className='lg:text-[4.5vh] lg:text-start text-center font-bold mb-12 leading-tight tracking-tight'>Introduction to getlinked<br /><span className='text-[#d434fe]'>tech Hackathon 1.0</span></div></Slide>
                <Slide duration={5000} direction='right' delay={1000}><div className='text-[80%] lg:text-start text-center leading-relaxed'>Our tech hackathon is a melting pot of<br className='block lg:hidden'/> visionaries, and its purpose is as <br className='hidden lg:block'/>
