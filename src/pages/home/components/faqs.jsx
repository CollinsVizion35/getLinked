...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "You can contact us through any of our social media page, our direct message is always open.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "You need a team to start the Hackathon, you can join 1 or startup yours.",
  },
  {
...
function Faqs() {
  ...
  return (
    <div className="lg:h-[100vh] h-fit py-6  mx-auto w-[100vw] flex lg:flex-row flex-col items-center px-[5vw] border-b border-[#2c233e] relative">
      ...
      <img
        src={ques}
        className="absolute bottom-[40vh] lg:top-[9vh] left-[22%] lg:left-[53%] h-[8vh]"
      />
      <img
        src={ques2}
        className="absolute bottom-[42vh] lg:top-[5vh] left-[40%] lg:left-[61%] h-[8vh]"
      />
      <img
        src={ques}
        className="absolute bottom-[39vh] lg:top-[10vh] left-[53%] lg:left-[73%] h-[8vh]"
      />
      {/*  designs  ends--------------------------------------------------------------------------- */}
      <div className="lg:w-[40vw]  ml-[5%]">
        ...
        <div className="flex flex-col space-y-3">
          {faqData.map((item, index) => (
            <div
              key={index}
              className={`flex flex-col faq-item border-b border-[#d434fe] ${
                openIndex === index ? "active" : ""
              }`}
            >
              <Slide direction="right" duration={5000}>
                <div
                  className="flex flex-row justify-between items-center p-2 text-sm"
                ...
                <div
                  className={`answer text-[0.7em] transition-opacity  ${
                    openIndex === index
                      ? "opacity-100 p-2 duration-500"
                      : "opacity-0 h-0 p-0 duration-0"
                  }`}
                >
                  {item.answer}
                </div>
      ...
      <div className="w-[60vw]">
        <JackInTheBox duration={5000}>
          <img
            src={manThink}
            alt="man Thinking"
            className="lg:h-[75vh] h-[40vh] ml-[5%] mt-[17.5vh] lg:mt-0 w-[90%]"
          />
        </JackInTheBox>
      </div>
    </div>
