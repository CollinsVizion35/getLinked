    ...
    return (
        <div className='min-h-[50vh]  max-w-[100vw] lg:max-w-[1440px] flex lg:flex-row flex-col-reverse items-center px-[5%] py-[5vh] lg:py-0 relative border-b border-[#2c233e]'>
            ...
            <div className='flex  flex-col ml-[5%]'>
                <Slide duration={5000} direction='left'><div className='lg:text-[4.5vh] lg:text-start text-center  font-bold lg:mb-12 mb-3 leading-tight tracking-tight'>Rules and<br /><span className='text-[#d434fe]'>Guidelines</span></div></Slide>
                <Slide duration={5000} direction='left' delay={1000}><div className='text-[80%] lg:text-start text-center leading-relaxed'>Our tech hackathon is a melting pot of<br className='block lg:hidden' /> visionaries, and its purpose is as <br className='hidden lg:block' />
                    ...
                    that's what we're all about!</div></Slide>
            </div>
            <div className='lg:w-[50%] w-[100%] py-[5vh] relative'>
                <JackInTheBox duration={5000} delay={1000}><img src={womanSit} alt='woman sitting' className='h-[50vh] lg:ml-[5%] w-[90%] z-[999] lg:h-[50vh] mx-auto' /></JackInTheBox>
