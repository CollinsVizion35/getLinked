...
function Criteria () {
  return (
    <div className='lg:h-[100vh] h-fit py-6  max-w-[100vw] lg:max-w-[1440px] lg:text-start text-center flex lg:flex-row flex-col items-center px-[5vw] border-b border-[#2c233e] relative'>
      ...
      <Bounce duration={3000} triggerOnce><img src={manWoman} alt='man and woman' className='z-[9999]' /></Bounce>
        <img
          src={pinkEllipse}
          alt='pinkEllipse'
      ...
      <div className='lg:w-[50%] w-[90%] flex flex-col'>
        <Fade duration={5000}><div className='lg:text-[1.5rem] text-[1em] font-bold lg:mb-12 mb-6'>
          Judging Criteria
          <br />
        ...
        <Slide direction="right" duration={5000}><div className=' mx-auto lg:mx-0'>
          ...
          <Slide direction="right" duration={5000} delay={500}><div className=' mx-auto lg:mx-0'>
          ...
          <Slide direction="right" duration={5000} delay={700}><div className=' mx-auto lg:mx-0'>
          ...
          <Slide direction="right" duration={5000} delay={900}><div className=' mx-auto lg:mx-0'>
          ...
          <Slide direction="right" duration={5000} delay={1100}><div className=' mx-auto lg:mx-0'>
        ...
        <Fade duration={5000}><button className='w-fit mt-12 mx-auto lg:mx-0'>Read More</button></Fade>
      </div>
    </div>
  )
}
