...
function RegisterBox() {
  ...
  return (
    <div className="lg:h-[85vh] h-fit lg:mt-[15vh] w-[100vw] lg:max-w-[1440px] flex lg:flex-row flex-col items-center px-[10vw]">
      {/* design ---------------------------------------------------- */}
          ...
          <form className="flex flex-col lg:space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="flex lg:flex-row flex-col lg:space-x-3 lg:space-y-0 space-y-2 mt-2">
              ...
              <div className="flex flex-col space-y-2 w-[100%]">
                ...
                <input
                  ...
                  id="project_topic"
                  value={project_topic}
                  onChange={(event) => setProject_topic(event.target.value)}
                />
              </div>
            </div>
            ...
            <div className="flex flex-row space-x-3 mt-2 lg:mt-auto">
              <div className="flex flex-col space-y-2 lg:w-[100%] w-[120%]">
                ...
                <select
                  className=" bg-transparent border rounded-[2px] text-[0.6em] border-[#918d99] w-[100%] mx-auto p-3"
                  id="category"
                  value={category}
                ...
                >
                  ...
                  {categories.length > 0 ? (
                    ...
                    <div>
                      <h3
                        className="text-2xl text-[#0A8453] font-Nunito fixed top-1/2 left-1/2 p-10 z-[1000]"
              ...
              <div className="flex flex-col space-y-2 lg:w-[100%] w-[80%]">
                ...
                >
                  <option className="bg-[#150e28]" value="Select">
                    Select
                  </option>

                  <option className="bg-[#150e28]" value="1">
                    1
                  </option>
                  <option className="bg-[#150e28]" value="2">
                    2
                  </option>
                  <option className="bg-[#150e28]" value="3">
                    3
                  </option>
                  <option className="bg-[#150e28]" value="4">
                    4
                  </option>
                  <option className="bg-[#150e28]" value="5">
                    5
                  </option>
                  <option className="bg-[#150e28]" value="6">
                    6
                  </option>
                  <option className="bg-[#150e28]" value="7">
                    7
                  </option>
                  <option className="bg-[#150e28]" value="8">
                    8
                  </option>
                  <option className="bg-[#150e28]" value="9">
                    9
                  </option>
